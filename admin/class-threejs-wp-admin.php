...
class Threejs_Wp_Admin {
	...
	public function enqueue_all( $hook ) {
		...
		$partials_url = plugin_dir_url(__FILE__) . 'partials/';

		// Load only on ?page=threejs-wp_page_threejs-wp-modals
		if ('threejs-wp_page_threejs-wp-modals' === $hook) {
			// Automatically load imported dependencies and assets version.
			$asset_file = include $partials_path . 'menu-modals/build/index.asset.php';
			...
			// Load our app.js.
			wp_enqueue_script( 'menu-modals', $partials_url . 'menu-modals/build/index.js', $asset_file['dependencies'], $asset_file['version'] , true);

			// Load our style.css.
			wp_enqueue_style( 'menu-modals', $partials_url . 'menu-modals/build/index.css', [], $asset_file['version'] );
